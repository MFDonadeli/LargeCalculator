...
/**
 * Created by mfdonadeli on 5/24/16.
 */
...
public class ExpandableTextView extends LinearLayout {
    ...
    public ExpandableTextView(Context context, AttributeSet attrs) {
        ...
        mCollapsedHeight = (int) getResources().getDimension(R.dimen.display_text_size);
    ...
    protected void onMeasure(int widthMeasureSpec,
        ...
        int height = displayMetrics.heightPixels - (getResources().getDimensionPixelSize(R.dimen.min_display_text_size)*3);
